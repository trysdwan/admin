// Global variables
    ...
    // Navigate to post with URL parameter (no localStorage)
    ...
    function renderSearchResults(posts) {
        ...
        // Hide hero and related sections for search results
        document.getElementById("heroPostContainer").style.display = "none";
        document.getElementById("relatedSection").style.display = "none";
        document.getElementById("sliderSection").style.display = "none";
        document.getElementById("remainingPostsSection").style.display = "block";
        
        // Render search results as grid
    ...
    function renderPostsGrid(posts, limit) {
        ...
        // Attach event listeners - using navigateToPost with URL parameter
    ...
    function renderFullPage() {
        ...
        // Render related posts (only if we have more posts)
        ...
        // Render remaining posts grid (excluding hero)
    ...
    function renderHeader(title, logoUrl, menus) {
        ...
        // Attach search event listeners after header is rendered
        setTimeout(() => {
            const desktopInput = document.getElementById("desktopSearchInput");
